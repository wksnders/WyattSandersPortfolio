namespace WyattSandersPortfolio.Models.PortfolioData
{
    ...
    public class ProjectData
    {
        ...
        public static readonly Dictionary<string, ImgProjectData> ImgProjectsToDescriptions = new Dictionary<string, ImgProjectData>
        {
            ...
            { "GameExecutionFlowchart", new ImgProjectData{DisplayName = "Game Execution Flowchart",DisplayImg = "Images/GamesProjects/GameExecutionFlowChart.png" , Caption="Constructed a game execution flowchart as a design blueprint, delineating heirarchy and order of in-game systems." } },
            ...
            { "FalterGame", new ImgProjectData{DisplayName = "Falter",DisplayImg = "Images/GamesProjects/FalterBanner.png" , Caption="Embark on a dark quest for justice grow to master the blade in \"Falter,\" a gripping game set against the backdrop of invasion" } },
            ...
            { "MarbleDrop", new ImgProjectData{DisplayName = "Marble Drop",DisplayImg = "Images/GamesProjects/MarbleDrop.png" , Caption="Simple yet addicting marble drop game. Keep the marble alive by skillfully maneuvering left and right, finging the gaps in ascending platforms." } }
        };
        public static readonly Dictionary<string, TextOnlyProjectData> textProjectsToDescriptions = new Dictionary<string, TextOnlyProjectData>
        {
            ...
            { "HackTheU", new TextOnlyProjectData{DisplayName = "Hack The U", Description=  "HackTheU 2019 - Used ERSI mapping API to gamify identification of real-world places.\r\nUseless Inventions Hackathon(2019) - Used REACT to make a text editor that deleted text. \r\nHackTheU 2018 - Used ALGOLIA (a search API) to develop an app to organize/prioritize tasks; Award: Best Use of ALGOLIA"  } },
